...
namespace EntityFrameworkCorePartitionPoC.Infrastructure.Migrations
{
    ...
    [Migration("20250205175205_ComputePartitionKey")]
    partial class ComputePartitionKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EntityFrameworkCorePartitionPoC.Infrastructure.Order", b =>
                {
                    ...
                    b.Property<string>("PartitionKey")
                        ...
                        .HasComputedColumnSql("CAST(YEAR(OrderDate) AS nvarchar(4)) + 'Q' + CAST(DATEPART(QUARTER, OrderDate) AS nvarchar(1))", true);
